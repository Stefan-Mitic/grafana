...
func (ms *MigrationService) insertRules(ctx context.Context, l log.Logger, rules []models.AlertRule) error {
	l.Info("Inserting migrated alert rules", "count", len(rules))
